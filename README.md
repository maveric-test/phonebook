...
![Phonebook Screenshot](phonebook_screenshot.png "Phonebook Screenshot")
...
- The URL to use is https://github.com/vaadin/phonebook.git
...
- Team -> Git -> Clone
- Set repository URL to https://github.com/vaadin/phonebook.git
- Finish
- Right click the imported project (Vaadin Phonebook Application) and select Run
...
- Set the repository URL to https://github.com/vaadin/phonebook.git
- Right click the imported "phonebook" and choose Run As -> Maven Build...
